...
export default function StockTable({ queryConditions }) {
  ...
  const sizeOfLastPage = filteredData.length % pageSize || pageSize;
  return (
    <div className="space-y-4">
      <p className="text-sm text-gray-500 pl-2">{pageSize*(pageOptions.length-1) + sizeOfLastPage} results found: Showing page {pageIndex + 1} of {pageOptions.length}</p>
